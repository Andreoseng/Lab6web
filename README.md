...
5. membuat hero panel disini saya menggunakan class jumbroton warna background secondary dan opacity sebesar 25 
 Menambah element lain pada content seperti gambar dan lain sebagainya, pada bootstrap kita bisa menggunakan cards, disini saya akan menggunakan col untuk membagi gambar per bagian masing-masing agar hasilnya lebih rapih. Dan membuat gambar menjadi bulat dengan menggunakan class rounded-circle
![img](ss/s3.png)
6. Menambahkan widget link pada sebelah kanan card 1
![img](ss/s4.png)
7. Menambah element lain atau card 2 seperti pada gambar dibawah ini
![img](ss/s5.png)
8. Menambaahkn footer
![img](ss/s6.png)
# TERIMAKASI